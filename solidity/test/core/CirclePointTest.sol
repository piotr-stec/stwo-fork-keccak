...
//         (KeccakChannelLib.ChannelState memory channelState, QM31Field.QM31 memory randomFelt) = channel.drawSecureFelt();
...
//         // Test U32 drawing
//         (KeccakChannelLib.ChannelState memory channelState, uint32[] memory randomU32s )= channelState.drawU32s();
